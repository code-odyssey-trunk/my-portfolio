...
const Contact = () => {
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        const publicKey = process.env.NEXT_PUBLIC_EMAILJS_API_KEY || 'default_public_key';
    ...
    return (
        <div id="contact" className="bg-gray-900 py-10 lg:px-30 px-4">
            <div className="container mx-auto">
                <div className="text-3xl text-white text-center mb-10">Get in Touch</div>
                <form onSubmit={handleSubmit} className="max-w-lg mx-auto bg-gray-800 p-8 rounded-lg shadow-lg">
                    ...
                    <div className="text-center">
                        ...
                        {feedbackMessage ? (
                            <div className={`mt-6 p-4 rounded-lg text-center max-w-lg mx-auto ${isError
