  ...
  return (
    <div id="contact" className="bg-gray-900 py-10 lg:px-30 px-4">
      <div className="container mx-auto">
        <div className="text-3xl text-blue-500 text-center mb-10">
          Get in Touch
        </div>
        <form
        ...
        >
          <div className="mb-4">
            ...
            <input
              className="w-full px-3 py-2 text-white placeholder-gray-500 bg-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              type="text"
              id="name"
              name="name"
