...
const Intro = () => {
    const phrases = useMemo(() => ["A Software Developer", "A Fullstack Developer"], []);
            ...
            <div className="container mx-auto flex flex-col lg:flex-row items-center">
                ...
                <div className="mt-6 lg:mt-0 lg:ml-10 text-center lg:text-left">
                    ...
                    <div className="text-violet-400 text-2xl lg:text-4xl mt-4">
                        {currentPhrase}<span className="animate-blink">|</span>
                    </div>
                    ...
                    <div className="mt-6">
                        <a className="px-4 py-2 bg-violet-700 text-white rounded-lg hover:bg-violet-600 transition-colors" href="#journey">My story</a>
                        <a className="ml-5 px-4 py-2 text-white border border-gray-600 rounded-lg hover:bg-gray-800 transition-colors" href="#">See my work</a>
                    </div>
                </div>
            </div>
        </div>
