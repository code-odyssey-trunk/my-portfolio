        ...
        <footer className="bg-gray-900 px-4 lg:px-30 pb-15">
            <div className="container mx-auto flex flex-col lg:flex-row bg-gray-800 rounded-2xl p-10 lg:p-20 border border-gray-700 shadow-lg">
                ...
                <div className="w-full lg:w-1/3 flex flex-col space-y-3 border-t lg:border-t-0 lg:border-l border-gray-700 pt-10 lg:pt-0 lg:pl-10 text-gray-300">
                    <Link href="#intro" className="hover:text-violet-400 transition-colors">About Me</Link>
                    <Link href="#skills" className="hover:text-violet-400 transition-colors">Skills</Link>
                    <Link href="#journey" className="hover:text-violet-400 transition-colors">My Journey</Link>
                ...
                <div className="w-full lg:w-1/3 flex flex-col space-y-3 border-t lg:border-t-0 lg:border-l border-gray-700 pt-10 lg:pt-0 lg:pl-10 text-gray-300">
                    <div className="hover:text-violet-400 transition-colors">
                        ...
                        <Link href="https://www.linkedin.com/in/jasimlz" target="_blank" className="ml-2">LinkedIn</Link>
                    </div>
                    <div className="hover:text-violet-400 transition-colors">
                        <FontAwesomeIcon icon={faGithub} className="text-gray-400" />
                        <Link href="https://github.com/code-odyssey-trunk?tab=repositories" target="_blank" className="ml-2">GitHub</Link>
                    </div>
                    <div className="hover:text-violet-400 transition-colors">
                        <FontAwesomeIcon icon={faInstagram} className="text-violet-400" />
                        <Link href="https://www.instagram.com/code_odyssey" target="_blank" className="ml-2">Instagram</Link>
                    </div>
                    <div className="hover:text-violet-400 transition-colors">
                        <FontAwesomeIcon icon={faYoutube} className="text-red-400" />
                        <Link href="https://www.youtube.com/@codeodyssey" target="_blank" className="ml-2">YouTube</Link>
                    </div>
                </div>
                <div className="w-full lg:w-1/3 flex flex-col space-y-3 border-t lg:border-t-0 lg:border-l border-gray-700 pt-10 lg:pt-0 lg:pl-10 text-gray-300">
                    <h3 className="font-semibold text-white mb-2">Subscribe to my newsletter</h3>
                    ...
                    <p className="text-xs text-gray-400 mt-2">I respect your privacy. Unsubscribe at any time.</p>
                </div>
            </div>
        </footer>
    )
